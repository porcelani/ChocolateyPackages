...
$packageName= 'prtscr' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://www.fiastarta.com/PrtScr/PrtScrSetup.exe' # download url, HTTPS preferred
#$fileLocation = Join-Path $toolsDir 'PrtScrSetup.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'prtscr*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '159CC63D01F9539CC7B7D726BB5DE44E2118E6D6573BB235ED0DE394F4AEBE33'
